<template>
  <div class="w-full overflow-x-auto">
    <DataTable :value="items" :loading="loading" showGridlines>
      ...
      <Column
        field="name"
        :header="t('pages.rentals.dictionaries.apartments.columns.name')"
      >
      ...
      <Column
        field="description"
        :header="t('pages.rentals.dictionaries.apartments.columns.description')"
      >
        <template #body="slotProps">
          <span>{{
      ...
      <Column
        field="is_active"
        :header="t('pages.rentals.dictionaries.apartments.columns.status')"
      >
        <template #body="slotProps">
